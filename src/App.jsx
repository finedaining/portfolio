...
const PROJECTS = [
  ...
  },
  {
    ...
    title: '캐스키드슨',
    desc: '라이프스타일 브랜드의 온라인 상세페이지 리뉴얼 프로젝트. 오프라인 패키지가 가진 독창적인 브랜드 감성에 비해 기존 웹 화면은 심플함이 강조되어 톤앤매너의 불일치가 존재했습니다. 패키지의 메인 컬러 톤과 시각적 오브젝트를 상세페이지 전반에 녹여내어 온·오프라인의 일관된 브랜드 경험을 완성했습니다. 정돈된 레이아웃으로 유저의 몰입감을 높여 한층 자연스럽고 매끄러운 구매 플로우를 구축했습니다.햣',
    tags: ['상세페이지'],
  ...
  },
  {
    ...
    title: '지구자바',
    desc: '친환경 제로웨이스트 브랜드 지구자바의 디지털 확장 프로젝트. PC·모바일 웹과 앱 3개 플랫폼을 구축하고, 플로깅 및 챌린지 참여로 굿즈 할인을 받는 순환형 리워드 시스템을 설계했습니다. 딥 그린 컬러 위주의 디자인과 캐릭터 요소를 더해 자연 친화적이면서도 친근한 분위기의 브랜드 경험으로 재탄생시켰습니다.',
  ...
  },
  {
    ...
    title: '이노벨',
    desc: '클린 & 퓨어 뷰티 브랜드 이노벨의 졸업 전시 팀 프로젝트. PC·모바일 웹 UI/UX 설계부터 친환경 패키지 및 굿즈 디자인까지 브랜딩 전 과정을 완수했습니다. 맑고 깨끗한 톤의 디자인으로 지속 가능한 가치를 투명하게 담아내어, 피부와 환경을 모두 고려한 진정성 있는 브랜드 경험을 완성했습니다.',
  ...
  },
  {
    ...
    title: '두드림',
    desc: '기계부품 제조 기술력을 바탕으로 한 두드림 브랜드 런칭 프로젝트. 단단한 금속과 미래를 두드린다는 의미를 담아 견고한 아이덴티티를 구축했습니다. 차분한 블루 그레이 톤 위주의 디자인으로 기술적 신뢰감을 더하고, 정돈된 화면 구성으로 사용성과 개발 효율성을 함께 확보했습니다.',
  ...
  },
  {
    ...
    title: '빈티지하우스',
    desc: '프리미엄 빈티지 가구 브랜드 빈티지 하우스의 이커머스 구축 프로젝트. 브랜드 감성을 살린 UI 디자인과 반응형 HTML/CSS 퍼블리싱을 진행했습니다. 따뜻하고 클래식한 브라운 톤 위주의 디자인과 세련된 폰트 매칭으로 빈티지 하우스만의 코지한 분위기와 브랜드 아이덴티티를 전달합니다.',
    tags: ['Frontend', 'Branding'],
